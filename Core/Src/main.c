...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
#define OUT1 GPIO_PIN_11 // PIN PA4
#define OUT2 GPIO_PIN_5 // PIN PA4
#define OUT3 GPIO_PIN_6 // PIN PA4
#define OUT4 GPIO_PIN_7 // PIN PA4
#define OUT5 GPIO_PIN_6 // PIN PA4
#define OUT6 GPIO_PIN_7 // PIN PA4
#define OUT7 GPIO_PIN_9 // PIN PA4
#define OUT8 GPIO_PIN_8 // PIN PA4
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LD1_Pin|LD5_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD1_Pin LD5_Pin */
  GPIO_InitStruct.Pin = LD1_Pin|LD5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
